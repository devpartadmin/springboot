...
public class AddressController {
    @Autowired
    private ReciveAddressService service;
    @GetMapping("getAddressByUser")
    public ResultVO getAddressByUser(HttpServletRequest request){
        ResultVO addressByUserId = service.getAddressByUserId(request);
        return addressByUserId;
    }

    @PostMapping("insertAddresses")
    public ResultVO insertAddresses(HttpServletRequest request,String json){
       return service.insertAddresses(request,json);
    }
}
